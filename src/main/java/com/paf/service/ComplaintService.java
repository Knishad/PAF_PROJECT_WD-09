...
public class ComplaintService {
	...
	public String insertcomplaint(Complaint complaint) {
		String query = " insert into complaint(`ComplaintId`,`UserId`,`ComplaintDate`,`Complaint`)"
				+ " values (?,?, ?, ?)";
	...
	public String readcomplaints() {
		...
		try {
			...
			output = "<table border=\"1\"><tr><th>Complaint Id</th><th>User Id</th><th>Complaint Date</th><th>Complaint</th></tr>";
	...
	public String updatecomplaint(Complaint complaint) {
		...
		String query = "UPDATE complaint SET UserId=?,ComplaintDate=?,Complaint=? WHERE ComplaintId=?";
		String output = "";
		try {
